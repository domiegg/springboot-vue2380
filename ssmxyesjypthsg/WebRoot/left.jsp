...
<body id="bg">
	...
	<div class="container">
		...
		<div class="leftsidebar_box"><a href="sy.jsp" target="main"><div class="line"><img src="images/coin01.png" />&nbsp;&nbsp;首页</div></a>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="images/coin03.png" /><img class="icon2" src="images/coin04.png" /> 热门资讯管理<img class="icon3" src="images/coin19.png" /><img class="icon4" src="images/coin20.png" />
				</dt>
				
				
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xinwentongzhi_add.jsp?lb=热门资讯" target="main">热门资讯添加</a><img class="icon5" src="images/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xinwentongzhiList.do?lb=热门资讯" target="main">热门资讯查询</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="shangpinxinxiList.do" target="main">商品信息管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="images/coin07.png" /><img class="icon2" src="images/coin08.png" /> 所有购买记录<img class="icon3" src="images/coin19.png" /><img class="icon4" src="images/coin20.png" />
				</dt>
				
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="goumaijiluList.do" target="main">所有购买记录</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="images/coin10.png" /><img class="icon2" src="images/coin09.png" /> 所有订单<img class="icon3" src="images/coin19.png" /><img class="icon4" src="images/coin20.png" />
				</dt>
			
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="dingdanxinxiList.do" target="main">所有订单</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a href="yonghuzhuceList.do" target="main" class="cks">用户注册管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
