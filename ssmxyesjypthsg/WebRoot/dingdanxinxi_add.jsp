...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">订单金额：</td><td><input name='dingdanjine' type='text' id='dingdanjine' value='<%=request.getParameter("je")%>' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
		...
		<tr ><td width="200">收货地址：</td><td><input name='dizhi' type='text' id='dizhi' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr><script language="javascript">document.form1.dizhi.value='<%=connDbBean.readzd("yonghuzhuce","dizhi","yonghuming",(String)request.getSession().getAttribute("username"))%>';document.form1.dizhi.setAttribute("readOnly",'true');</script>
